...
return [
    ...
    'common/Article/delete' => [1,2,3],
    'common/Article/update' => [1, 2, 3],
    'common/Article/read' => [1, 2, 3],
    'common/TypeTag/index' => [1, 2,3],
    ...
    'wx/Question/save' => [1, 2, 3],
    'common/Question/update' => [1, 2, 3],
    'wx/Question/update' => [1, 2, 3],
    'common/Question/read' => [1, 2, 3],
    'wx/Question/read' => [1, 2, 3],
    'common/Question/delete' => [1,2,3],
    'common/Types/index' => [1, 2],
    'common/Types/save' => [1, 2],
    'common/Types/update' => [1, 2],
    'common/Types/read' => [1, 2],
    //'common/Types/delete' => [1,2],
    'common/Tags/index' => [1, 2,3],
    'common/Tags/save' => [1, 2,3],
    'common/Tags/update' => [1, 2,3],
    'common/Tags/read' => [1, 2,3],
    ...
    'common/Tdk/save' => [2,3],
    'common/Tdk/search' => [2,3],
    'common/Tdk/read' => [2],
    'common/Tdk/getAkeyword' => [2,3],
    'common/Tdk/editpageinfo' => [2,3],
    ...
    'common/CreativeActivity/index' => [2],
    'common/CreativeActivity/read' => [2],
    'common/CreativeActivity/save' => [2],
    'common/CreativeActivity/update' => [2],
    'common/CreativeActivity/delete' => [2],
    ...
    'common/Childsitelist/childsitelist'=>[2,3],
